...
def single_instance_less_tokens_setup(instances):
    ...
    vocabulary = Vocab(instances=single_instance,
...
class TestNumericalizer:
    def test_max_length_instance_has_less_tokens_than_max_length(self, single_instance_less_tokens_setup):
        single_instance, MAX_LENGTH, numericalizer, vocabulary = single_instance_less_tokens_setup

        len_tokens, numerical_tokens = numericalizer.numericalize_instance(single_instance[0])

        assert len(numerical_tokens) == MAX_LENGTH

    def test_start_end_token_instance_has_less_tokens(self, single_instance_less_tokens_setup):
        single_instance, MAX_LENGTH, numericalizer, vocabulary = single_instance_less_tokens_setup
        len_tokens, numerical_tokens = numericalizer.numericalize_instance(single_instance[0])
    ...
    def test_start_end_token_instance_has_more_tokens_than_max_length(self, single_instance_more_tokens_setup):
        single_instance, MAX_LENGTH, numericalizer, vocabulary = single_instance_more_tokens_setup
        len_tokens, numerical_tokens = numericalizer.numericalize_instance(single_instance[0])
    ...
    def test_max_lengths_instance_has_less_tokens_than_max_length(self, single_instance_less_tokens_setup):
        single_instance, MAX_LENGTH, numericalizer, vocabulary = single_instance_less_tokens_setup

        len_tokens, numerical_tokens = numericalizer.numericalize_batch_instances([single_instance[0],
                                                                                   single_instance[0]])
    ...
    def test_start_end_token_max_length_2(self, single_instance_2_tokens_setup):
        ...
        """
        single_instance, MAX_LENGTH, numericalizer, vocabulary = single_instance_2_tokens_setup
        len_tokens, numerical_tokens = numericalizer.numericalize_instance(single_instance[0])
