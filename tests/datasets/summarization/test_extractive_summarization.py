import pytest
from sciwing.datasets.summarization.extractive_text_summarization_dataset import ExtractiveSummarizationDataset, ExtractiveSummarizationDatasetManager
...
class TestDatasetManager:
    ...
    def test_texclassification_dataset_manager_in_nursery(self, ext_sum_dataset_manager):
        assert (
