...
from parsect.utils.common import download_file, extract_zip
...
def project_setup():
    ...
    msg_printer.divider('Settting up parsect for development')
    ...
    try:
        ...
        with msg_printer.loading('Downloading sect label file'):
            gdd.download_file_from_google_drive(file_id=SECT_LABEL_FILE_GID,
